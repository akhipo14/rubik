...
@section('content')
    ...
    <div class="container">
        <h3 style="color: white">Edit Artikel</h3>
        <div class="card p-3 mb-3" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; ">
            <form action="/admin-artikel/{{ $artikels->id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row gap-3 p-3">
                    <div class="col col-lg-3 mb-3">
                        ...
                        <div class="d-flex justify-content-start ">
                            <img src="{{ asset('storage/' . $artikels->image) }}"
                    ...
                    <div class="col ">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="judul"
                                    ...
                                    placeholder="Sukses menjadi pengusaha" value="{{ $artikels->judul }}">
                                @error('judul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col pt-3">
                            ...
                            <textarea type="text" name="deskripsi" class="form-control @error('deskripsi')is-invalid @enderror"
                                placeholder="Kiat untuk menjadi seorang pengusaha sukses ..." rows="7">{{ $artikels->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

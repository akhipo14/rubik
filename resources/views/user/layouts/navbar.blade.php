<div class="navbar ">
    ...
    <div class="nav kanan">
        ...
        <ul>
            ...
            <li>
                <div class="a ">
                    <a href="/market" class="{{ Request::is('market*') ? 'active' : '' }}">Market</a>
                </div>
            </li>
            <li>
                <div class="a ">
                    <a href="/mentor" class="{{ Request::is('mentor*') ? 'active' : '' }}">Mentor</a>
                </div>
            </li>
            <li>
                <div class="a">
                ...
                <li>
                    <div class="dropdown">
                        <button class="dropbtn">
                            @if (Auth::user()->image)
                                <img src="{{ asset('storage/' . Auth::user()->image) }}" style="width: 25px; height: 25px;"
                                    alt="">
                            @else
